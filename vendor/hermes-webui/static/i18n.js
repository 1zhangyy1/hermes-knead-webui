...
const LOCALES = {
  ...
  folder_add_as_space_title: 'Add as Space?',
    ...
    new_conversation: 'New task',
    filter_conversations: 'Search conversations...',
  ...
  folder_add_as_space_title: '添加为工作区？',
    ...
    empty_subtitle: '先选一个 AI 产品聊天；反复出现的工作，会逐步沉淀成它自己的产品界面。',
    cancel: '取消',
    loading: '加载中…',
    create_job: '创建任务',
    suggest_plan: '做融资 PPT 大纲',
    suggest_schedule: '写一份周报大纲',
    suggest_files: '总结当前工作区',
    sign_out: '退出登录',
    // Providers panel (English fallback — native translations welcome in follow-up PRs)
