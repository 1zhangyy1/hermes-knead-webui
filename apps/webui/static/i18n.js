...
const LOCALES = {
  en: {
    offline_title: '连接已断开',
    offline_browser_detail: '当前设备似乎离线了。',
    offline_network_detail: '暂时连接不上运行时。',
    offline_autorefresh: '恢复连接后会自动刷新这一页。',
    offline_check_now: '立即检查',
    offline_checking: '正在检查…',
    offline_stream_waiting: '连接已断开，恢复后会自动刷新…',
    _lang: 'en',
    _label: 'English',
    _speech: 'en-US',
    // boot.js
    ...
    voice_dictate: '语音输入',
    voice_dictate_active: '停止语音输入',
    voice_mode_toggle: '语音对话',
    voice_mode_toggle_active: '退出语音对话',
    // Turn-based voice mode (#1333)
    voice_listening: '正在听…',
    voice_speaking: '正在说…',
    voice_thinking: '思考中…',
    voice_error: '当前浏览器不支持语音',
    voice_mode_active: '语音对话已开启',
    voice_mode_off: '语音对话已关闭',
    ...
    mcp_restart_hint: 'Server changes are read-only here for now. Edit config.yaml and restart the runtime for changes to take effect.',
    ...
    mcp_tools_runtime_note: '工具清单只读取当前运行时已知的数据；前端不会主动启动或探测服务器。',
    ...
    mcp_tools_inactive_configured_servers: (servers) => `已配置但当前运行时未激活：${servers}。`,
    ...
    reconnect_active: 'A reply is still generating. Reload when ready?',
    reconnect_finished: 'A reply was in progress when you left. Messages may have updated.',
    // approval card
    approval_heading: '需要确认',
    approval_desc_prefix: '检测到需要确认的操作',
    approval_btn_once: '允许一次',
    approval_btn_once_title: '允许这一次操作（Enter）',
    approval_btn_session: '本任务允许',
    approval_btn_session_title: '在当前任务中允许',
    approval_btn_always: '始终允许',
    approval_btn_always_title: '始终允许同类操作',
    approval_btn_deny: '拒绝',
    approval_btn_deny_title: '拒绝，不执行这个操作',
    approval_responding: '正在提交\u2026',
    clarify_heading: 'More information needed',
    clarify_hint: 'Choose an option, or type your answer.',
    clarify_other: 'Other',
    clarify_send: 'Send',
    clarify_input_placeholder: 'Type your answer...',
    clarify_responding: 'Sending\u2026',
    untitled: 'Untitled',
    n_messages: (n) => `${n} messages`,
    load_older_messages: '↑ Scroll up or click to load older messages',
    session_jump_start: '开头',
    session_jump_start_label: '回到任务开头',
    session_jump_end: '底部',
    session_jump_end_label: '回到任务底部',
    ...
    workspace_new_worktree_conversation: '在工作树中新建任务',
    workspace_new_worktree_conversation_meta: '为当前任务创建隔离的工作树。',
    workspace_worktree_created: '工作树任务已创建',
    workspace_worktree_failed: '工作树创建失败：',
    session_worktree_badge: '工作树',
    model_scope_advisory: '从下一条消息开始应用到当前任务。',
    model_scope_toast: '从下一条消息开始应用到当前任务。',
    // commands.js
    ...
    settings_label_busy_input_mode: '运行中发送',
    settings_desc_busy_input_mode: '控制 Agent 运行时继续发送消息的处理方式：排队等待当前任务完成；中断会停止当前任务并重新开始；中途修正会尽量把补充要求加入当前执行。',
    settings_label_fade_text_effect: '文字淡入效果',
    settings_desc_fade_text_effect: '流式回复时让新文字轻微淡入；默认关闭以保持性能。',
    settings_busy_input_mode_queue: '排队等待',
    settings_busy_input_mode_interrupt: '中断当前任务',
    settings_busy_input_mode_steer: '中途修正',
  ...
  cmd_btw_usage:'/btw <question> — ask a side question using session context',
   ...
   cmd_branch:'把当前任务分支成一个新任务',
   cmd_branch_usage:'/branch [名称] — 创建任务分支（可选名称）',
   branch_forked:'已创建分支任务',
   branch_failed:'创建分支失败：',
   fork_from_here:'从这里创建分支',
   forked_from:'来自',
   subagent_children:'子任务',
  ...
  stream_stopped:'已停止回复。',
  no_active_task:'没有正在处理的任务。',
  cancel_unavailable:'当前不能取消。',
  retry_failed:'重试失败：',
  undo_failed:'撤销失败：',
  undid_n_messages:'Removed',
  undid_messages_suffix:'message(s).',
  status_heading:'任务状态',
  status_session_id:'任务 ID',
  status_title:'标题',
  status_model:'模型',
  status_provider:'模型服务',
  status_workspace:'任务空间',
  status_personality:'人格',
  status_messages:'消息',
  status_agent_running:'Agent 运行中',
    status_profile: '配置',
    status_hermes_home: '运行时目录',
    status_started: '开始时间',
    status_updated: '更新时间',
    status_tokens: 'Token',
    status_ephemeral: '临时快照，不会写入任务记录。',
    status_no_tokens: '暂无 token 数据',
    status_unknown: '未知',
  status_yes:'Yes',
  status_no:'No',
  status_load_failed:'Failed to load status: ',
  title_current:'当前标题',
  title_change_hint:'使用 `/title <新标题>` 重命名。',
  title_set:'标题已改为',
  ...
  usage_load_failed:'Failed to load usage: ',
    ...
    // Task toolsets (#493)
    session_toolsets:'任务工具',
    session_toolsets_desc:'限制当前任务可用的工具；留空则使用全局配置。',
    session_toolsets_global:'全局默认',
    session_toolsets_custom:'自定义',
    session_toolsets_placeholder:'tool1, tool2, …',
    session_toolsets_apply:'应用',
    session_toolsets_clear:'清除并使用全局',
    session_toolsets_applied:'任务工具已更新',
    session_toolsets_cleared:'已恢复全局工具配置',
    session_toolsets_failed:'更新任务工具失败：',
  untitled:'Untitled',
    ...
    terminal_open_title: '打开任务终端',
    terminal_no_workspace_title: '先选择任务空间再打开终端',
    terminal_title: '终端',
    terminal_clear: '清空',
    ...
    terminal_expand: '展开',
    terminal_close: '关闭',
    terminal_input_placeholder: '运行命令...',
    terminal_start_failed: '终端启动失败：',
    terminal_input_failed: '终端输入失败：',
    terminal_copy_failed: '复制失败：',
    terminal_error: '终端错误',
    workspace_empty_no_path: '还没有文件。',
    workspace_empty_dir: 'Files 还是空的。',
    workspace_show_hidden_files: '显示隐藏文件',
    workspace_show_hidden_files_desc: '在任务空间里显示 .DS_Store、.git、node_modules 等隐藏或系统文件。',
    workspace_hidden_files_visible: '隐藏文件已显示',
    workspace_hidden_files_visible_title: '隐藏文件已显示，点击查看选项',
    workspace_options: 'Files 选项',
    dialog_confirm_title: '确认操作',
    dialog_prompt_title: '输入内容',
    dialog_confirm_btn: '确认',
    // workspace.js
    unsaved_confirm: '预览里有未保存的修改，要放弃并继续吗？',
    discard: '放弃',
    save: '保存',
    edit: '编辑',
    clear: '清空',
    ...
    reveal_failed: '打开位置失败：',
    copy_file_path: '复制文件路径',
    path_copied: '文件路径已复制',
    path_copy_failed: '复制路径失败：',
    session_rename: '重命名任务',
    session_rename_desc: '修改这个任务的标题',
  ...
  workspace_auto_create_folder: '文件夹不存在时自动创建',
  folder_add_as_space_btn: '加入任务空间',
  folder_add_as_space_msg: '把这个文件夹加入任务空间列表？',
  folder_add_as_space_title: '加入任务空间？',
    remove_title: '移除',
    empty_dir: '空文件夹',
    upload_failed: '上传失败：',
    upload_too_large: (maxMb, fileMb) => `文件过大（${fileMb} MB），最大支持 ${maxMb} MB。`,
    all_uploads_failed: (n) => `${n} 个文件上传失败`,
    archive_extracted: (n, c) => `已从 ${c} 个压缩包解出 ${n} 个文件`,
    session_pin: '固定任务',
    session_unpin: '取消固定',
    session_pin_desc: '固定在任务列表顶部',
    session_unpin_desc: '从固定列表移除',
    session_pin_failed: '固定失败：',
    session_move_project: '移动到项目',
    session_move_project_desc_has: '更改这个任务所属的项目',
    session_move_project_desc_none: '把这个任务加入项目',
    session_archive: '归档任务',
    session_restore: '恢复任务',
    session_archive_desc: '从当前任务列表隐藏',
    session_archive_worktree_desc: '归档任务，保留磁盘上的工作树',
    session_restore_desc: '恢复到主任务列表',
    session_archived: '任务已归档',
    session_archived_worktree: '任务已归档。工作树仍保留在磁盘上。',
    session_restored: '任务已恢复',
    session_archive_failed: '归档失败：',
    session_duplicate: '复制任务',
    session_duplicate_desc: '用相同设置创建一个副本',
    session_duplicated: '任务已复制',
    session_duplicate_failed: '复制失败：',
    session_stop_response: '停止回复',
    session_stop_response_desc: '取消这个任务正在生成的回复',
    session_delete: '删除任务',
    session_delete_desc: '永久删除这个任务',
    session_delete_confirm: '删除这个任务？',
    session_delete_worktree_desc: '只删除任务记录，保留磁盘上的工作树',
    session_delete_worktree_confirm: (path) => `删除这个任务？${path} 的工作树会保留在磁盘上。`,
    session_deleted: '任务已删除',
    session_deleted_worktree: '任务已删除。工作树仍保留在磁盘上。',
    session_worktree_remove: '移除工作树',
    session_worktree_remove_desc: (path) => `从磁盘删除 ${path} 的 git 工作树`,
    session_worktree_remove_confirm: (path) => `要从磁盘移除 git 工作树吗？\n\n路径：${path}\n\n这会删除整个工作树目录，任务记录会保留。`,
    session_worktree_remove_not_exists: (path) => `${path} 的工作树已经不存在。`,
    session_worktree_remove_confirm_label: '移除',
    session_worktree_removed: '工作树已移除。',
    session_worktree_remove_failed: '移除工作树失败：',
    session_worktree_remove_status_failed: '读取工作树状态失败：',
    session_worktree_remove_locked_by_stream: '正在处理的任务使用了这个工作树，暂时不能移除。',
    session_worktree_remove_locked_by_terminal: '终端正在使用这个工作树，暂时不能移除。',
    session_worktree_remove_unsafe_blocked: '移除前需要先处理本地修改或未推送提交。',
    session_worktree_remove_dirty_warning: '警告：这个工作树有未提交修改，移除后会丢失。',
    session_worktree_remove_untracked_warning: (count) => `${count} 个未跟踪文件会被永久删除。`,
    session_worktree_remove_ahead_warning: (ahead) => `${ahead} 个未推送提交会丢失。`,
    session_select_mode: '选择',
    session_select_mode_desc: '批量管理任务',
    session_select_all: '全选',
    session_deselect_all: '取消全选',
    session_selected_count: '已选择 {0} 个',
    session_batch_archive: '归档',
    session_batch_delete: '删除',
    session_batch_move: '移动到项目',
    session_batch_delete_confirm: '删除 {0} 个任务？',
    session_batch_archive_confirm: '归档 {0} 个任务？',
    session_batch_delete_worktree_confirm: '删除 {0} 个任务？其中 {1} 个任务的工作树会保留在磁盘上。',
    session_batch_archive_worktree_confirm: '归档 {0} 个任务？其中 {1} 个任务的工作树会保留在磁盘上。',
    session_no_selection: '还没有选择任务',
    // settings panel
    settings_heading_title: '设置',
    settings_heading_subtitle: '偏好、任务工具和系统控制。',
    settings_section_conversation_title: '任务',
    settings_section_appearance_title: '外观',
    settings_section_appearance_meta: '主题、配色和字体。',
    settings_section_preferences_title: '偏好',
    settings_section_preferences_meta: '新任务默认值和界面行为。',
    ...
    settings_updates_available: '有 {count} 个更新',
    settings_updates_disabled: '更新检查已关闭',
    settings_update_check_failed: '更新检查失败',
    settings_label_workspace_panel_open: '新任务默认打开 Files',
    settings_desc_workspace_panel_open: 'When enabled, new tasks open the workspace panel automatically. You can still hide it anytime.',
    settings_label_session_jump_buttons: '显示任务跳转按钮',
    settings_desc_session_jump_buttons: '阅读长任务记录时显示回到开头和底部的浮动按钮。',

    settings_label_session_endless_scroll: '向上滚动时加载更早消息',

    settings_desc_session_endless_scroll: '启用后，向上滚动会自动加载更早的任务消息。',
    open_in_browser: '在浏览器中打开',
    settings_dropdown_conversation: '任务',
    settings_dropdown_appearance: '外观',
    settings_dropdown_preferences: '偏好',
    settings_dropdown_providers: '模型服务',
    settings_dropdown_system: '系统',
    settings_tab_conversation: '任务',
    settings_tab_appearance: '外观',
    settings_tab_preferences: '偏好',
    settings_tab_plugins: '插件',
    settings_plugins_title: '插件',
    settings_plugins_meta: '查看已安装的运行时插件和它们注册的生命周期钩子。此处只读。',
    settings_plugins_empty: '当前没有可见的运行时插件。请在 CLI 或配置中安装并启用。',
    plugins_unnamed: '未命名插件',
    plugins_no_description: '没有说明。',
    plugins_no_hooks: '没有注册钩子',
    ...
    settings_desc_model: '用于新任务。已有任务保留各自选定的模型。',
    settings_label_send_key: '发送方式',
    settings_label_theme: '主题',
    settings_label_skin: '配色',
    ...
    settings_label_quota_chip: '在输入框显示模型额度',
    settings_desc_quota_chip: '在输入框底部显示剩余额度，例如 OpenRouter 余额。默认关闭；开启后只在宽屏显示，避免输入区拥挤。',
    settings_label_token_usage: '显示 token 用量',
    settings_label_sidebar_density: '侧栏密度',
    cmd_reasoning: '切换思考过程显示、设置思考强度或查看当前状态',
    settings_label_external_sessions: '显示外部任务',
    settings_label_check_updates: '检查更新',
    settings_label_whats_new_summary: '用 AI 总结更新',
    settings_label_bot_name: '显示名称',
    settings_label_password: '访问密码',
    settings_saved: '设置已保存',
    settings_save_failed: '保存失败：',
    settings_load_failed: '设置加载失败：',
    settings_saved_pw: '设置已保存，密码保护已开启，当前浏览器会保持登录',
    settings_saved_pw_updated: '设置已保存，密码已更新',
    // login page (used server-side via /api/i18n/login endpoint)
    login_title: '登录',
    login_subtitle: '输入密码后继续',
    ...
    transcript: 'Markdown',
    download_transcript: '导出 Markdown',
    import: '导入',
    export_session_json: 'JSON',
    export_session_json_tooltip: '将任务完整导出为 JSON',
    import_session_json_tooltip: '从 JSON 导入任务',
    clear_conversation_btn_tooltip: '清空当前任务的所有消息',
    // Settings detail
    settings_label_rtl: '聊天区从右到左布局',
    settings_desc_rtl: '用于阿拉伯语、希伯来语等语言，只影响聊天消息和输入框，侧栏与其他面板保持从左到右。',
    settings_label_sound: '提示音',
    settings_desc_sound: 'Play a sound when an AI finishes replying.',
    // TTS (#499)
    tts_listen: '朗读',
    tts_not_supported: '当前浏览器不支持语音合成。',
    settings_label_tts: '回复朗读',
    settings_desc_tts: '在每条 AI 回复上显示朗读按钮，使用浏览器语音合成读出内容。',
    settings_label_tts_auto_read: '自动朗读回复',
    settings_desc_tts_auto_read: '每条新回复完成后自动朗读；你开始输入时暂停。',
    // Composer voice-mode pref (#1488)
    settings_label_voice_mode: '免手动语音按钮',
    settings_desc_voice_mode: 'Show the voice mode button next to dictation. The current AI sends after a pause and can read replies aloud when supported.',
    settings_label_tts_voice: '朗读声音',
    settings_desc_tts_voice: '优先使用的声音，来自浏览器可用声音列表。',
    settings_label_tts_rate: '语速',
    settings_label_tts_pitch: '音高',
    settings_label_notifications: '浏览器通知',
    settings_desc_notifications: '应用在后台时，回复完成后显示系统通知。',
    settings_desc_token_usage: '在每条 AI 回复下方显示输入和输出 token 数，也可以用 /usage 切换。',
    settings_label_api_redact: '隐藏 API 响应中的敏感数据',
    settings_desc_api_redact: '自托管用户可以为透明度关闭此项；共享实例不建议关闭。',
    settings_sidebar_density_compact: '紧凑',
    settings_sidebar_density_detailed: '详细',
    settings_desc_sidebar_density: '控制左侧任务列表显示多少元信息。',
    settings_label_auto_title_refresh: '自动刷新任务标题',
    ...
    settings_desc_auto_title_refresh: '根据最新消息自动更新任务标题。需要配置标题生成模型。',
    settings_desc_external_sessions: '在任务列表中显示来自 CLI、Telegram、Discord、Slack 等渠道的任务。点击可导入并继续。',
    settings_desc_check_updates: '当前端或 Agent 有新版本时显示提示，并定期在后台检查。',
    settings_desc_whats_new_summary: '先生成一段更好读的更新摘要，原始对比仍然可以继续查看。',
    settings_desc_bot_name: 'Display name across the app. Default: Knead.',
    settings_desc_password: 'Enter a new password to set or change it. Leave blank to keep the current setting.',
    password_placeholder: 'Enter new password...',
    password_env_var_locked: 'HERMES_WEBUI_PASSWORD is set and takes priority. Remove it and restart the server to manage the password here.',
    password_env_var_locked_placeholder: 'Locked: HERMES_WEBUI_PASSWORD is set',
    disable_auth: '关闭登录保护',
    sign_out: '退出登录',
    // Providers panel
    providers_tab_title: '模型服务',
    providers_section_title: '模型服务',
    providers_section_meta: '管理模型服务的 API Key，保存后立即生效。',
    providers_status_configured: 'API Key 已配置',
    providers_status_not_configured: '没有 API Key',
    providers_status_oauth: 'OAuth',
    providers_status_api_key: 'API key',
    providers_status_not_configured_label: '未配置',
    providers_oauth_hint: '已通过 OAuth 认证，不需要 API Key。',
    providers_oauth_config_yaml_hint: 'Token 已通过 config.yaml 配置。需要更新时，编辑 config.yaml 的 providers 配置或运行 hermes auth。',
    providers_oauth_not_configured_hint: '尚未认证。请在终端运行 hermes auth 配置此模型服务。',
    providers_save: '保存',
    providers_remove: '移除',
    providers_saving: '保存中…',
    providers_removing: '移除中…',
    providers_enter_key: '请输入 API Key',
    providers_empty: '还没有可配置的模型服务。',
    ...
    editing: 'Editing',
    // Empty state
    empty_title: 'What should we work on?',
    empty_subtitle: 'Start with an AI product. Repeated work can grow its own product UI.',
    suggest_files: 'Summarize this workspace',
    suggest_schedule: 'Draft a weekly report',
    suggest_plan: 'Create a pitch deck outline',
    // onboarding
    onboarding_badge: 'FIRST USE',
    onboarding_title: 'Welcome to Knead',
    onboarding_lead: 'Finish the minimum setup, choose a model and workspace, then start creating, using, and shaping your AI products.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip',
    onboarding_skipped: 'Setup skipped, using existing config.',
    onboarding_open: 'Open Knead',
    onboarding_step_system_title: 'Runtime check',
    onboarding_step_system_desc: 'Verify that the local agent runtime is reachable.',
    onboarding_step_setup_title: 'Model setup',
    onboarding_step_setup_desc: 'Save the minimum provider configuration.',
    onboarding_step_workspace_title: 'Workspace and model',
    onboarding_step_workspace_desc: 'Pick defaults for new AI product tasks.',
    ...
    onboarding_step_finish_desc: 'Review and enter Knead.',
    onboarding_notice_system_ready: 'The local agent runtime is reachable.',
    onboarding_notice_system_unavailable: 'The local agent runtime is not fully available yet. Provider setup may still require a terminal.',
    ...
    onboarding_notice_finish: 'You can change these settings later.',
    ...
    clear_conversation_title: '清空任务消息',
    clear_conversation_message: '要清空当前任务的所有消息吗？此操作无法撤销。',
    ...
    profile_switched_new_conversation: (name) => `已切换配置：${name}，并开始新任务`,
    ...
    active_conversation_none: '还没有选择任务。',
    ...
    cron_profile_server_default_hint: '运行时使用服务端默认配置。没有配置的旧任务会保留这个行为。',
    ...
    composer_send: '发送消息',
    composer_queue: '排队发送',
    composer_interrupt: '打断并发送',
    composer_steer: '补充当前回复',
    composer_stop: '停止生成',
    composer_disabled_clarify: '先回复确认问题',
    composer_disabled_compression: '正在整理上下文',
    composer_disabled_empty: '输入消息后发送',
    composer_mobile_workspace: 'Files',
  ...
  zh: {
    ...
    offline_network_detail: '当前浏览器暂时连接不上运行时。',
    offline_autorefresh: '恢复连接后会自动刷新这一页。',
    offline_check_now: '立即检查',
    offline_checking: '正在检查…',
    ...
    mcp_restart_hint: '服务器更改目前为只读。请编辑 config.yaml 并重启运行时。',
    ...
    session_jump_start: '开头',
    session_jump_start_label: '跳转到任务开头',
    session_jump_end: '结尾',
    session_jump_end_label: '跳转到任务结尾',
    ...
    provider_mismatch_warning: (m,p)=>`\"${m}\" 可能无法在当前模型服务 (${p}) 下工作。直接发送，或在终端运行 \`hermes model\` 切换。`,
    provider_mismatch_label: '模型服务不匹配',
    ...
    ws_search_placeholder: '搜索任务空间…',
    ws_no_results: '未找到任务空间',
    workspace_new_worktree_conversation: '在 worktree 中新建任务',
    workspace_new_worktree_conversation_meta: '为这个任务空间创建隔离的 git worktree。',
    workspace_worktree_created: '已创建 worktree 任务',
    ...
    session_toolsets_cleared: '已恢复全局工具配置',
    session_toolsets_failed: '更新任务工具失败：',
    model_scope_advisory: '从下一条消息起应用于当前任务。',
    model_scope_toast: '从下一条消息起应用于当前任务。',
    // commands.js
    cmd_help: '查看可用命令',
    cmd_clear: '清空当前任务消息',
    cmd_compress: '手动压缩任务上下文（用法：/compress [主题]）',
    ctx_compress_hint: '压缩上下文以释放空间 →',
    ctx_compress_action: '⚠ 立即压缩以释放上下文',
    cmd_compact_alias: '旧别名：/compress',
    cmd_model: '切换模型（例如 /model gpt-4o）',
    cmd_workspace: '按名称切换任务空间',
    cmd_terminal: '打开任务终端',
    cmd_new: '新建任务',
    cmd_usage: '切换 token 用量显示',
    cmd_theme: '切换外观（主题：system/dark/light，配色：default/ares/mono/slate/poseidon/sisyphus/charizard/sienna/catppuccin/nous）',
    ...
    switched_workspace: '已切换任务空间：',
    workspace_switch_failed: '任务空间切换失败：',
    new_session: '已创建新任务',
    ...
    settings_plugins_title: '插件',
    settings_plugins_meta: '查看已安装的运行时插件和它们注册的生命周期钩子。此处只读。',
    settings_plugins_empty: '当前没有可见的运行时插件。通过 CLI/配置文件安装或启用后即可在此查看。',
    plugins_unnamed: '未命名插件',
  ...
  folder_add_as_space_title: '加入任务空间？',
    ...
    empty_subtitle: 'Pick an AI and start with one sentence. Repeated work can grow into its own workspace.',
    cancel: '取消',
    loading: '加载中…',
    create_job: '创建任务',
    suggest_plan: '做融资 PPT 大纲',
    suggest_schedule: '写一份周报大纲',
    suggest_files: '总结当前任务空间',
    sign_out: '退出登录',
    // Providers panel (English fallback — native translations welcome in follow-up PRs)
    providers_tab_title: '模型服务',
    providers_section_title: '模型服务',
    ...
    provider_quota_title: '当前模型服务额度',
    provider_quota_active_provider: '当前模型服务',
    ...
    provider_quota_refresh_title: '立即刷新模型服务用量限制',
    provider_quota_refresh_succeeded: '模型服务用量已刷新',
    provider_quota_refresh_failed: '模型服务用量刷新失败',
    ...
    settings_sidebar_density_compact: '紧凑',
    settings_sidebar_density_detailed: '详细',
    settings_desc_sidebar_density: '控制左侧任务列表展示多少元信息。',
    settings_label_auto_title_refresh: '自动刷新任务标题',
    settings_auto_title_refresh_off: '关闭',
    settings_auto_title_refresh_5: '每 5 轮对话',
    settings_auto_title_refresh_10: '每 10 轮对话',
    ...
    settings_desc_whats_new_summary: '先生成一段更好读的更新摘要，原始对比仍然可以继续查看。',
    settings_desc_bot_name: 'Display name across the app. Default: Knead.',
    settings_desc_password: '输入新密码即可设置或修改；留空表示保持当前设置。',
    // onboarding
    ...
    onboarding_open: 'Open Knead',
    onboarding_step_system_title: '运行环境检查',
    onboarding_step_system_desc: '确认本地 agent runtime 可以访问。',
    onboarding_step_setup_title: '模型设置',
    onboarding_step_setup_desc: '保存最小可用的模型服务配置。',
    onboarding_step_workspace_title: '任务空间和模型',
    onboarding_step_workspace_desc: 'Choose defaults for new AI tasks.',
    onboarding_step_password_title: '可选密码',
    onboarding_step_password_desc: '在分享前为 Web UI 添加保护。',
    onboarding_step_finish_title: '完成',
    onboarding_step_finish_desc: 'Review and enter Knead.',
    onboarding_notice_system_ready: '本地 agent runtime 可以访问。',
    onboarding_notice_system_unavailable: '本地 agent runtime 尚未完全可用，模型服务设置可能仍需要终端。',
    onboarding_check_agent: 'Agent runtime',
    ...
    onboarding_check_provider: '模型服务配置',
    ...
    onboarding_notice_setup_required: '请先在此选择一个简单的模型服务路径。高级 OAuth 流程暂时仍建议在 Hermes CLI 中完成。',
    onboarding_notice_setup_already_ready: '已检测到可用的 Hermes 模型服务配置。你可以保留它，或在这里替换。',
    onboarding_oauth_provider_ready_title: '模型服务已完成认证',
    onboarding_oauth_provider_ready_body: '此实例已配置为使用通过 Hermes CLI 设置的 OAuth 模型服务（<strong>{provider}</strong>）。这里不需要 API key，点击继续即可完成设置。',
    onboarding_oauth_provider_not_ready_title: 'OAuth 模型服务尚未认证',
    onboarding_oauth_provider_not_ready_body: '此实例已配置为使用 <strong>{provider}</strong>，该模型服务使用 OAuth 而非 API key。请在终端运行 <code>hermes auth</code> 或 <code>hermes model</code> 完成认证，然后重新加载 Web UI。',
    onboarding_oauth_switch_hint: '或者在下方选择其他模型服务，切换到 API key 配置：',
    onboarding_notice_workspace: '这些值复用与正式应用相同的设置 API。',
    onboarding_workspace_label: '任务空间',
    onboarding_workspace_or_path: '或输入任务空间路径',
    onboarding_workspace_placeholder: '/home/you/workspace',
    ...
    onboarding_workspace_help: '选择设置完成后新任务默认使用的模型。',
    onboarding_custom_model_placeholder: 'your-model-name',
    ...
    onboarding_notice_finish: '之后仍可在设置中修改这些选项。',
    ...
    onboarding_error_choose_workspace: '继续前请先选择任务空间。',
    ...
    onboarding_error_workspace_required: '必须填写任务空间。',
    ...
    agent_soul: '智能体灵魂',
    no_soul_yet: '暂无灵魂定义。',
    workspace_choose_path: '选择任务空间路径',
    workspace_choose_path_meta: '添加已校验路径并切换当前任务',
    workspace_manage: '管理任务空间',
    workspace_manage_meta: '打开 Spaces 面板',
    workspace_use_title: '用于当前任务',
    workspace_use: '使用',
    workspace_add_path_placeholder: '添加任务空间路径（例如 /home/user/my-project）',
    workspace_paths_validated_hint: '保存前会校验路径是否为已存在目录。',

    workspace_drag_hint: '拖动以重新排序',
    workspace_reorder_failed: '重新排序失败',
    workspace_added: '任务空间已添加',
    workspace_renamed: '任务空间已重命名',
    workspace_remove_confirm_title: '移除任务空间',
    workspace_remove_confirm_message: (path) => `要移除"${path}"吗？`,
    workspace_removed: '任务空间已移除',
    workspace_switch_prompt_title: '切换任务空间',
    workspace_switch_prompt_message: '输入绝对路径以添加并切换当前任务的任务空间。',
    workspace_switch_prompt_confirm: '切换',
    workspace_switch_prompt_placeholder: '/Users/you/project',
    workspace_not_added: '任务空间未添加成功',
    workspace_already_saved: '任务空间已存在，请在列表中选择',
    workspace_busy_switch: 'Agent 运行中，无法切换任务空间',
    discard_file_edits_title: '放弃文件编辑？',
    discard_file_edits_message: '切换任务空间将丢弃预览区未保存的文件修改。',
    ...
    profile_model_label: '模型 / 模型服务',
    profile_model_hint: '为这个新配置选择已配置的模型服务和模型。',
    ...
    profile_switched_new_conversation: (name) => `已切换到配置档：${name}，并开始新任务`,
    ...
    cron_profile_server_default_hint: '运行时使用服务端默认配置档。没有配置档的现有任务会保留这个行为。',
    ...
    session_archive: '归档任务',
    session_archive_desc: '从当前任务列表隐藏',
    session_archive_worktree_desc: '归档任务，并保留磁盘上的 worktree',
    session_archive_failed: '归档失败：',
    session_archived: '任务已归档',
    session_archived_worktree: '任务已归档。Worktree 仍保留在磁盘上。',
    session_delete: '删除任务',
    session_delete_desc: '永久删除这个任务',
    session_delete_confirm: '删除这个任务？',
    session_delete_worktree_desc: '只删除任务记录，保留磁盘上的 worktree',
    session_delete_worktree_confirm: (path) => `删除这个任务？位于 ${path} 的 worktree 会保留在磁盘上。`,
    session_deleted: '任务已删除',
    session_deleted_worktree: '任务已删除。Worktree 仍保留在磁盘上。',
    session_worktree_remove: '删除 worktree',
    session_worktree_remove_desc: (path) => `删除位于 ${path} 的 git worktree`,
    session_worktree_remove_confirm: (path) => `确定从磁盘删除 git worktree？\n\n路径：${path}\n\n整个 worktree 目录将被删除，任务记录会保留。`,
    ...
    session_worktree_remove_locked_by_stream: '无法删除，正在处理的任务使用了这个 worktree。',
    session_worktree_remove_locked_by_terminal: '无法删除，任务终端正在使用这个 worktree。',
    ...
    session_duplicate: '复制任务',
    session_duplicate_desc: '用相同任务空间和模型创建副本',
    session_duplicate_failed: '复制失败：',
    session_stop_response: '停止回复',
    session_stop_response_desc: '取消这个任务正在进行的回复',
    session_duplicated: '任务已复制',
    ...
    session_select_mode: '选择',
    session_select_mode_desc: '选择任务以批量管理',
    session_select_all: '全选',
    session_deselect_all: '取消全选',
    ...
    session_batch_delete_confirm: '删除 {0} 个任务？',
    session_batch_archive_confirm: '归档 {0} 个任务？',
    session_batch_delete_worktree_confirm: '删除 {0} 个任务？其中 {1} 个任务会把 worktree 目录保留在磁盘上。',
    session_batch_archive_worktree_confirm: '归档 {0} 个任务？其中 {1} 个任务会把 worktree 目录保留在磁盘上。',
    session_no_selection: '还没有选择任务',
    settings_dropdown_appearance: '外观',
    settings_dropdown_conversation: '任务',
    settings_dropdown_preferences: '偏好',
    ...
    settings_section_preferences_meta: '新任务默认值和界面行为。',
    settings_section_preferences_title: '偏好',
    settings_section_system_meta: '版本和访问控制。',
    settings_check_now: '立即检查',
    settings_checking: '检查中\u2026',
    settings_up_to_date: '已是最新 \u2713',
    ...
    settings_desc_workspace_panel_open: 'When enabled, new tasks open the workspace panel automatically. You can still hide it anytime.',
    settings_label_session_jump_buttons: '显示任务跳转按钮',
    settings_desc_session_jump_buttons: '阅读较长任务记录时显示悬浮的开头和结尾按钮。',
    ...
    settings_tab_system: '系统',
    status_updated: '已更新',
    status_ephemeral: '临时快照，不会保存到任务记录。',
    ...
    approval_skip_all: '⚡ 本任务全部跳过',
    approval_skip_all_title: '跳过本任务的所有确认提示',
    // composer action tooltips
    composer_send: '发送消息',
    ...
    checkpoint_date: '日期',
    checkpoint_diff_files_changed: (n) => `${n} file${n === 1 ? '' : 's'} changed`,  // TODO: translate
    checkpoint_diff_no_changes: '此检查点与当前任务空间之间无差异。',
    checkpoint_diff_title: '检查点变更',
    checkpoint_empty: '当前任务空间未找到检查点。',
    checkpoint_error: '加载检查点失败',
    checkpoint_files: '文件',
    checkpoint_loading: '加载检查点中…',
    checkpoint_message: '消息',
    checkpoint_restore: '恢复',
    checkpoint_restore_confirm_message: (ckpt) => `将任务空间恢复到检查点 "${ckpt}"？此操作将用已保存版本覆盖文件。此检查点之后添加的文件不会被删除。`,
  ...
  'zh-Hant': {
    ...
    mcp_tools_summary_showing: (start,end,filtered,searchNote,totalNote,page,pages) => `显示 ${start}-${end} / ${filtered} 个 MCP 工具${searchNote}${totalNote}。第 ${page}/${pages} 页。`,
  ...
  ko: {
    ...
    workspace_empty_no_path: 'No files yet. Start a task or upload something.',
    workspace_empty_dir: 'Files is empty.',
    workspace_show_hidden_files: '숨김 파일 표시',
    workspace_show_hidden_files_desc: 'Include .DS_Store, .git, node_modules, and other hidden / system files in the file tree.',
    workspace_hidden_files_visible: 'hidden visible',
    workspace_hidden_files_visible_title: 'Hidden files are visible — click for options',
    workspace_options: 'File options',
    ...
    settings_label_workspace_panel_open: '기본으로 Files 패널 열기',
