...
const LOCALES = {
  en: {
    ...
    reconnect_active: '回复还在生成中，准备好后重新加载吗？',
    reconnect_finished: '你离开时有回复正在生成，消息可能已经更新。',
    // approval card
    ...
    clarify_heading: '需要补充信息',
    clarify_hint: '选择一个选项，或直接输入你的回答。',
    clarify_other: '其他',
    clarify_send: '发送',
    clarify_input_placeholder: '输入你的回答…',
    clarify_responding: '正在发送\u2026',
    untitled: 'Untitled',
  ...
  folder_add_as_space_title: '加入任务空间？',
    ...
    settings_desc_workspace_panel_open: '启用后，新任务会自动打开任务空间面板，你仍然可以随时收起。',
    ...
    settings_desc_sound: 'AI 产品回复完成时播放提示音。',
    // TTS (#499)
    tts_listen: '朗读',
    ...
    settings_desc_voice_mode: '在听写旁显示语音模式按钮。当前 AI 产品会在停顿后发送，并在浏览器支持时朗读回复。',
    ...
    settings_desc_bot_name: '应用中的显示名称。默认为 Next AI。',
    settings_desc_password: '输入新密码即可设置或修改；留空表示保持当前设置。',
    password_placeholder: '输入新密码…',
    password_env_var_locked: '当前已设置 HERMES_WEBUI_PASSWORD 环境变量，并且优先级更高。取消该变量并重启服务后，才能在这里管理密码。',
    password_env_var_locked_placeholder: '已锁定：HERMES_WEBUI_PASSWORD 已设置',
    disable_auth: '关闭登录保护',
    sign_out: '退出登录',
    // Providers panel
    ...
    onboarding_title: 'Welcome to Next AI',
    onboarding_lead: 'Finish the minimum setup, choose a model and workspace, then start creating, using, and improving your AI products.',
    onboarding_back: 'Back',
    onboarding_continue: 'Continue',
    onboarding_skip: 'Skip',
    onboarding_skipped: 'Setup skipped, using existing config.',
    onboarding_open: 'Open Next AI',
    ...
    onboarding_step_finish_desc: 'Review and enter Next AI.',
  ...
  folder_add_as_space_title: '加入任务空间？',
    ...
    empty_subtitle: '先选一个 AI 产品开始任务；反复出现的工作，会逐步沉淀成它自己的任务界面。',
    cancel: '取消',
    loading: '加载中…',
    create_job: '创建任务',
    ...
    onboarding_title: '欢迎使用 Next AI',
    archive_extracted: (n, c) => `从 ${c} 个压缩包中解压了 ${n} 个文件`,
    onboarding_lead: '先完成最小设置，选择模型和任务空间，然后开始创建、使用和改造你的 AI 产品。',
    onboarding_back: '返回',
    onboarding_continue: '继续',
    onboarding_skip: '跳过',
    onboarding_skipped: '设置已跳过，使用现有配置。',
    onboarding_open: '打开 Next AI',
